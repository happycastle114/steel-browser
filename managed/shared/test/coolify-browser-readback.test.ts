...
const browserAndNetworkMutations: readonly (readonly [string, Mutation])[] = [
  ...
  ["missing user namespace selection", (r) => ({ ...r, browser: { ...r.browser, arguments: ["--headless=new", "--remote-debugging-port=0"] } })],
  ["sandbox flag", (r) => ({ ...r, browser: { ...r.browser, arguments: ["--headless=new", "--disable-setuid-sandbox", "--no-sandbox", "--remote-debugging-port=0"] } })],
  ["namespace sandbox flag", (r) => ({ ...r, browser: { ...r.browser, arguments: ["--headless=new", "--disable-setuid-sandbox", "--disable-namespace-sandbox", "--remote-debugging-port=0"] } })],
  ["fixed CDP port", (r) => ({ ...r, browser: { ...r.browser, arguments: ["--headless=new", "--disable-setuid-sandbox", "--remote-debugging-port=9223"] } })],
  ["additive fixed CDP port", (r) => ({ ...r, browser: { ...r.browser, arguments: ["--headless=new", "--disable-setuid-sandbox", "--remote-debugging-port=0", "--remote-debugging-port=9223"] } })],
